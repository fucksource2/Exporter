...
-- Thunk function for calling a function pointer with specified address and typestring.
...
-- Bind function to retrieve function pointers by module name, address, and typestring.
...
local native_FindWindowA = bind("kernel32.dll", "FindWindowA", "void*(__thiscall*)(void*, const char*, const char*)") -- example
